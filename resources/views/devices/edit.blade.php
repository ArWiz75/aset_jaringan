<x-app-layout>
    <x-slot name="title">Edit Perangkat</x-slot>
    @php 
        $fromOpd = request('from') === 'opd' || old('redirect_to_opd');
        $redirectToOpd = old('redirect_to_opd', $fromOpd ? $device->opd_location_id : null);
    @endphp
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white mt-2">Edit Perangkat</h1>
    </div>
